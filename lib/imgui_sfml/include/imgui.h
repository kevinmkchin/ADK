...
#include <string>                   // memset, memmove, memcpy, strlen, strchr, strcpy, strcmp
#include <vector>
...
namespace ImGui
{
    ...
    IMGUI_API void          DeactivateActiveItem();                                             // deactivates active item by setting active id to -1. kevinmkchin
