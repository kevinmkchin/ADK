...
## Usage
Just fork the repo and get started. Everything this engine needs is included within this repository. I'm working on ADK using Visual Studio 2019. If you want to compile ADK, you should consider using this IDE. This project only targets Windows. The VS project files are configured to compile with all the dependenices. If you want to compile ADK on MacOS, you will need to download the MacOS version of SFML. ImGui-SFML is platform agnostic I believe, so you don't need to download that. Set up additional include directories, additional library directories, and additional dependencies for SFML and ImGui-SFML in Visual Studio Mac or use CMake or whatever.
